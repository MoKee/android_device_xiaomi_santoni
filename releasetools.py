...
def ImportMainBootloaderFirmware(info):
  ...
  info.script.AppendExtra('package_extract_file("firmware-update/mdtp.img", "/dev/block/bootdevice/by-name/mdtp");')
  info.script.AppendExtra('package_extract_file("firmware-update/emmc_appsboot.mbn", "/dev/block/bootdevice/by-name/aboot");')
  info.script.AppendExtra('package_extract_file("firmware-update/lksecapp.mbn", "/dev/block/bootdevice/by-name/lksecapp");')
  info.script.AppendExtra('package_extract_file("firmware-update/sbl1.mbn", "/dev/block/bootdevice/by-name/sbl1");')
  ...
  info.script.AppendExtra('package_extract_file("firmware-update/adspso.bin", "/dev/block/bootdevice/by-name/dsp");')
...
def ImportBkpBootloaderFirmware(info):
  ...
  info.script.AppendExtra('package_extract_file("firmware-update/emmc_appsboot.mbn", "/dev/block/bootdevice/by-name/abootbak");')
  info.script.AppendExtra('package_extract_file("firmware-update/lksecapp.mbn", "/dev/block/bootdevice/by-name/lksecappbak");')
  info.script.AppendExtra('package_extract_file("firmware-update/sbl1.mbn", "/dev/block/bootdevice/by-name/sbl1bak");')
